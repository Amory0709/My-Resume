...
\begin{center}
    {\Huge \scshape Mengyu Han} \\ \vspace{1pt}
    Beijing, China \\ \vspace{1pt}
    \small \raisebox{-0.1\height}\faPhone\ +86 153-1191-7485 ~ \href{mailto:hamory@wustl.edu}{\raisebox{-0.2\height}\faEnvelope\  \underline{hamory@wustl.edu}} ~ 
    \href{https://www.linkedin.com/in/mengyu-amori-han-4667a5155/}{\raisebox{-0.2\height}\faLinkedin\ \underline{LinkedIn}}  ~
    \href{https://github.com/Amory0709/}{\raisebox{-0.2\height}\faGithub\ \underline{Github}}
    \vspace{-8pt}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Washington University in St. Louis}{Aug 2018 -- Dec 2019}
      {Master of Engineering, Information System Management}{St. Louis, Missouri, USA}
  \resumeSubHeadingListEnd
  \resumeSubHeadingListStart
    \resumeSubheading
      {Tianjin University of Finance and Economics}{Sep 2014 -- Jun 2018}
      {Bachelor of Science, Management Science}{Tianjin, China}
  \resumeSubHeadingListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {SLB(Schulumberger)}{Jun 2021 -- Now}
    ...
    \resumeSubheading
      {SLB(Schulumberger)}{Jan 2021 -- May 2023}
      {Software Engineer}{Beijing, China}
      \resumeItemListStart
        \resumeItem{Developed a service to automatically perform a set of unit tests daily on a product in development in order to decrease time needed for team members to identify and fix bugs/issues.}
        \resumeItem{Incorporated scripts using Python and PowerShell to aggregate XML test results into an organized format and to load the latest build code onto the hardware, so that daily testing can be performed.}
    ...
    \resumeSubheading
      {Chinese Academy of Science}{Sep 2020 -- Nov 2020}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{CarbonSCORE 2.0 Prototype} $|$ \emph{New Energy, Angular, C\#}}{Jan 2022 -- Oct 2022}
          \resumeItemListStart
          ...
          \vspace{-13pt}
      \resumeProjectHeading
          {\textbf{GIS visualization for StandbyHer Volunteer group} $|$ \emph{Data visualization, Python, Spark}}{May 2020 -- July 2020}
          \resumeItemListStart
